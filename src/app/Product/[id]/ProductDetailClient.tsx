      ...
      <section className="w-full">
        <div className="w-11/12 p-5">
          <div className="flex flex-col gap-5">
            <div className="grid grid-cols-2 gap-5 mx-auto w-11/12">
              ...
              <div className="w-full flex flex-col gap-10">
                <div className="flex flex-col gap-2">
                  <h1 className="text-sm md:text-3xl font-extrabold text-black">
                    {product.title}
                  </h1>
                ...
                <div className="flex">
                  <h1 className="text-sm md:text-4xl font-extrabold text-black">
                    ${product.price}
                  </h1>
                </div>
                <div className="flex flex-col">
                  <h1 className="font-medium text-xs md:text-sm">Kuantitas</h1>
